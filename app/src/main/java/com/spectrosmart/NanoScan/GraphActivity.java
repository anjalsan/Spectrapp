...
public class GraphActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.spectrosmart.NanoScan.R.layout.activity_graph);
        ...
        if (ab != null) {
            ...
            save.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (fileName.contains(".csv")){
                        ...
                        String csvOS = android.os.Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + fileName;
                        getdata(csvOS);
                    } else {
            ...
            report.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    analysisText.setTextColor(Color.parseColor("#000000"));
                    infoText.setTextColor(Color.parseColor("#77000000"));
            ...
            info.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    analysisText.setTextColor(Color.parseColor("#77000000"));
        ...
        graphListView = (ListView) findViewById(com.spectrosmart.NanoScan.R.id.lv_scan_data);
    }
...
//        RequestBody requestFile = RequestBody.create(MediaType.parse("multipart/form-data"), file);
    ...
    public void onResume() {
        ...
        try {
            ...
            try {
                ...
                e1.printStackTrace();
                Toast.makeText(mContext, getString(com.spectrosmart.NanoScan.R.string.file_not_found), Toast.LENGTH_SHORT).show();
                finish();
            }
        }
        ...
        if (graphList != null) {
            mAdapter = new ScanListAdapter(this, com.spectrosmart.NanoScan.R.layout.row_graph_list_item, graphList);

            graphListView.setAdapter(mAdapter);
        } else if (graphDict != null) {
            mAdapter = new ScanListAdapter(this, com.spectrosmart.NanoScan.R.layout.row_graph_list_item, graphDict);
            graphListView.setAdapter(mAdapter);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.spectrosmart.NanoScan.R.menu.menu_graph, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.spectrosmart.NanoScan.R.id.action_email) {
            if (findFile(fileName) != null) {
                Intent i = new Intent(Intent.ACTION_SEND);
                i.setType("message/rfc822");
                i.putExtra(Intent.EXTRA_SUBJECT, getString(com.spectrosmart.NanoScan.R.string.emailing) + fileName);
                i.putExtra(Intent.EXTRA_STREAM, Uri.fromFile(findFile(fileName)));
                try {
                    startActivity(Intent.createChooser(i, getString(com.spectrosmart.NanoScan.R.string.send_mail)));
                } catch (android.content.ActivityNotFoundException ex) {
                    Toast.makeText(GraphActivity.this, getString(com.spectrosmart.NanoScan.R.string.no_email_clients), Toast.LENGTH_SHORT).show();
                }
            } else {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = LayoutInflater.from(this.getContext())
                        .inflate(com.spectrosmart.NanoScan.R.layout.row_graph_list_item, parent, false);

                viewHolder = new ViewHolder();
                viewHolder.dataTitle = (TextView) convertView.findViewById(com.spectrosmart.NanoScan.R.id.tv_list_head);
                viewHolder.dataBody = (TextView) convertView.findViewById(com.spectrosmart.NanoScan.R.id.tv_list_data);
     ...
     * @param type the type of chart to be displayed {@link GraphActivity.ChartType}
     */
