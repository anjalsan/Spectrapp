...
public class ConfigureActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.spectrosmart.NanoScan.R.layout.activity_configure);
        ...
        if (ab != null) {
            ...
            ab.setTitle(getString(com.spectrosmart.NanoScan.R.string.configure));
        }

        //Get reference to listview and add the click listener
        ListView lv_configure = (ListView) findViewById(com.spectrosmart.NanoScan.R.id.lv_configure);
