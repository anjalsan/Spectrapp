...
public class ActiveScanActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.spectrosmart.NanoScan.R.layout.activity_active_scan);
        ...
        lv_configs = (ListView) findViewById(com.spectrosmart.NanoScan.R.id.lv_configs);
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(this.getContext())
                        .inflate(com.spectrosmart.NanoScan.R.layout.row_scan_configuration_item, parent, false);

                viewHolder = new ViewHolder();
                viewHolder.scanType = (TextView) convertView.findViewById(com.spectrosmart.NanoScan.R.id.tv_scan_type);
                viewHolder.rangeStart = (TextView) convertView.findViewById(com.spectrosmart.NanoScan.R.id.tv_range_start_value);
                viewHolder.rangeEnd = (TextView) convertView.findViewById(com.spectrosmart.NanoScan.R.id.tv_range_end_value);
                viewHolder.width = (TextView) convertView.findViewById(com.spectrosmart.NanoScan.R.id.tv_width_value);
                viewHolder.patterns = (TextView) convertView.findViewById(com.spectrosmart.NanoScan.R.id.tv_patterns_value);
                viewHolder.repeats = (TextView) convertView.findViewById(com.spectrosmart.NanoScan.R.id.tv_repeats_value);
                viewHolder.serial = (TextView) convertView.findViewById(com.spectrosmart.NanoScan.R.id.tv_serial_value);

                viewHolder.scanType.setVisibility(View.GONE);
                LinearLayout ll_range_start = (LinearLayout)convertView.findViewById(com.spectrosmart.NanoScan.R.id.ll_range_start);
                LinearLayout ll_range_end = (LinearLayout)convertView.findViewById(com.spectrosmart.NanoScan.R.id.ll_range_end);
                LinearLayout ll_patterns= (LinearLayout)convertView.findViewById(com.spectrosmart.NanoScan.R.id.ll_patterns);
                LinearLayout ll_width = (LinearLayout)convertView.findViewById(com.spectrosmart.NanoScan.R.id.ll_width);
            ...
            if (config != null) {
                ...
                viewHolder.rangeStart.setText(getString(com.spectrosmart.NanoScan.R.string.range_start_value, config.getWavelengthStartNm()));
                viewHolder.rangeEnd.setText(getString(com.spectrosmart.NanoScan.R.string.range_end_value, config.getWavelengthEndNm()));
                viewHolder.width.setText(getString(com.spectrosmart.NanoScan.R.string.width_value, config.getWidthPx()));
                viewHolder.patterns.setText(getString(com.spectrosmart.NanoScan.R.string.patterns_value, config.getNumPatterns()));
                viewHolder.repeats.setText(getString(com.spectrosmart.NanoScan.R.string.repeats_value, config.getNumRepeats()));
    ...
    public class SlewScanConfAdapter extends ArrayAdapter<KSTNanoSDK.SlewScanSection> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(this.getContext())
                        .inflate(com.spectrosmart.NanoScan.R.layout.row_slew_scan_configuration_item, parent, false);
