...
public class DeviceInfoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.spectrosmart.NanoScan.R.layout.activity_device_info);
        ...
        if (ab != null) {
            ...
            ab.setTitle(getString(com.spectrosmart.NanoScan.R.string.device_information));
        }

        //Get references to device info UI
        tv_manuf = (TextView) findViewById(com.spectrosmart.NanoScan.R.id.tv_manuf);
        tv_model = (TextView) findViewById(com.spectrosmart.NanoScan.R.id.tv_model);
        tv_serial = (TextView) findViewById(com.spectrosmart.NanoScan.R.id.tv_serial);
        tv_hw = (TextView) findViewById(com.spectrosmart.NanoScan.R.id.tv_hw);
        tv_tiva = (TextView) findViewById(com.spectrosmart.NanoScan.R.id.tv_tiva);
        tv_spec = (TextView) findViewById(com.spectrosmart.NanoScan.R.id.tv_spectrum);
        ...
        mInfoReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                ProgressBar pb = (ProgressBar) findViewById(com.spectrosmart.NanoScan.R.id.pb_info);
