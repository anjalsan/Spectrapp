...
public class DeviceStatusActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.spectrosmart.NanoScan.R.layout.activity_device_status);
        ...
        if(ab != null) {
            ...
            ab.setTitle(getString(com.spectrosmart.NanoScan.R.string.device_status));
        }

        //Get UI element references
        tv_batt = (TextView)findViewById(com.spectrosmart.NanoScan.R.id.tv_batt);
        tv_temp = (TextView)findViewById(com.spectrosmart.NanoScan.R.id.tv_temp);
        tv_humid = (TextView)findViewById(com.spectrosmart.NanoScan.R.id.tv_humid);
        et_tempThresh = (EditText)findViewById(com.spectrosmart.NanoScan.R.id.et_tempThresh);
        et_humidThresh = (EditText)findViewById(com.spectrosmart.NanoScan.R.id.et_humidThresh);
        Button btn_update_thresholds = (Button) findViewById(com.spectrosmart.NanoScan.R.id.btn_update_thresholds);
        ...
        if(!SettingsManager.getBooleanPref(this, SettingsManager.SharedPreferencesKeys.tempUnits,false)){
            et_tempThresh.setHint(com.spectrosmart.NanoScan.R.string.deg_c);
        }else{
            et_tempThresh.setHint(com.spectrosmart.NanoScan.R.string.deg_f);
        }
        ...
        mStatusReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                tv_batt.setText(getString(com.spectrosmart.NanoScan.R.string.batt_level_value, batt));
                if(!SettingsManager.getBooleanPref(mContext, SettingsManager.SharedPreferencesKeys.tempUnits, false)){
                    tv_temp.setText(getString(com.spectrosmart.NanoScan.R.string.temp_value_c, Float.toString(temp)));
                }else{
                    temp = (float)(temp * 1.8)+32;
                    tv_temp.setText(getString(com.spectrosmart.NanoScan.R.string.temp_value_f, Float.toString(temp)));
                }

                tv_humid.setText(getString(com.spectrosmart.NanoScan.R.string.humid_value, intent.getFloatExtra(KSTNanoSDK.EXTRA_HUMID, 0)));

                ProgressBar pb = (ProgressBar)findViewById(com.spectrosmart.NanoScan.R.id.pb_status);
