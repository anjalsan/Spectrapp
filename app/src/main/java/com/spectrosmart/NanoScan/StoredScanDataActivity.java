...
public class StoredScanDataActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.spectrosmart.NanoScan.R.layout.activity_stored_scan_data);
        scanIndexProgress = (ProgressBar) findViewById(com.spectrosmart.NanoScan.R.id.scanIndexProgress);
        tv_no_scans = (TextView) findViewById(com.spectrosmart.NanoScan.R.id.tv_no_scans);
        ...
        if (ab != null) {
            ...
            ab.setTitle(getString(com.spectrosmart.NanoScan.R.string.stored_scan_data));
        }
        ...
        storedScanSizeReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (storedScanSize > 0) {
                    ...
                    barProgressDialog.setTitle(getString(com.spectrosmart.NanoScan.R.string.reading_sd_card));
    ...
    private class StoredScanReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            final SwipeMenuListView lv_stored_scans = (SwipeMenuListView) findViewById(com.spectrosmart.NanoScan.R.id.lv_stored_scans);
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(this.getContext())
                        .inflate(com.spectrosmart.NanoScan.R.layout.row_stored_scan_item, parent, false);

                viewHolder = new ViewHolder();
                viewHolder.scanName = (TextView) convertView.findViewById(com.spectrosmart.NanoScan.R.id.tv_scan_name);
                viewHolder.scanDate = (TextView) convertView.findViewById(com.spectrosmart.NanoScan.R.id.tv_scan_date);
                viewHolder.scanIndex = (TextView) convertView.findViewById(com.spectrosmart.NanoScan.R.id.tv_scan_index);
    ...
    private String createTimeString(String scanDate) {
        ...
        try {
            ...
            String outFormat = "EEEE, M/d/yy " + getString(com.spectrosmart.NanoScan.R.string.time_format_at) + " HH:mm:ss";
