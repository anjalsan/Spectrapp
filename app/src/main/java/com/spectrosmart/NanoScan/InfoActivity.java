...
public class InfoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.spectrosmart.NanoScan.R.layout.activity_info);

        webView = (WebView) findViewById(R.id.web);

        webView.getSettings().setJavaScriptEnabled(true);
        webView.loadUrl("http://spectrosmart.net");
        ...
        infoList = (ListView) findViewById(com.spectrosmart.NanoScan.R.id.lv_info);
    }
    ...
    public void onResume() {
        ...
        int length = getResources().getStringArray(com.spectrosmart.NanoScan.R.array.info_title_array).length;
        int index;
        for (index = 0; index < length; index++) {
            infoManagerArrayList.add(new InfoManager(
                    getResources().getStringArray(com.spectrosmart.NanoScan.R.array.info_title_array)[index],
                    getResources().getStringArray(com.spectrosmart.NanoScan.R.array.info_body_array)[index],
                    getResources().getStringArray(com.spectrosmart.NanoScan.R.array.info_url_array)[index]));
        }

        final InformationAdapter adapter = new InformationAdapter(this, com.spectrosmart.NanoScan.R.layout.row_info_item, infoManagerArrayList);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.spectrosmart.NanoScan.R.menu.menu_info, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if (id == com.spectrosmart.NanoScan.R.id.action_settings) {
            return true;
        }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = LayoutInflater.from(this.getContext())
                        .inflate(com.spectrosmart.NanoScan.R.layout.row_info_item, parent, false);

                viewHolder = new ViewHolder();
                viewHolder.infoTitle = (TextView) convertView.findViewById(com.spectrosmart.NanoScan.R.id.tv_info_title);
                viewHolder.infoBody = (TextView) convertView.findViewById(com.spectrosmart.NanoScan.R.id.tv_info_body);
