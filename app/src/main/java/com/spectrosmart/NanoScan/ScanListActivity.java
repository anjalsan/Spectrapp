...
public class ScanListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.spectrosmart.NanoScan.R.layout.activity_scan_list);

        //Get UI elements references
        final RelativeLayout mSplashLayout = (RelativeLayout) findViewById(com.spectrosmart.NanoScan.R.id.rl_splash);
        final RelativeLayout mMainLayout = (RelativeLayout) findViewById(com.spectrosmart.NanoScan.R.id.rl_mainLayout);
        ...
        Animation animSplash = AnimationUtils.loadAnimation(this, com.spectrosmart.NanoScan.R.anim.alpha_splash);
    ...
    public void onResume() {
        ...
        lv_csv_files = (SwipeMenuListView) findViewById(com.spectrosmart.NanoScan.R.id.lv_csv_files);
        populateListView();
            ...
            public boolean onMenuItemClick(final int position, SwipeMenu menu, int index) {
                ...
                switch (index) {
                    case 0:
                        ...
                        break;
                    case 1:
                        renameFile(mAdapter.getItem(position), position);
                        break;
                }
                return false;
            }
        ...
        EditText searchText = (EditText) findViewById(com.spectrosmart.NanoScan.R.id.et_search);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.spectrosmart.NanoScan.R.menu.menu_scan_list, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if (id == com.spectrosmart.NanoScan.R.id.action_info) {
            Intent infoIntent = new Intent(this, InfoActivity.class);
            startActivity(infoIntent);
            return true;
        }

        else if (id == com.spectrosmart.NanoScan.R.id.action_scan) {
            Intent graphIntent = new Intent(mContext, NewScanActivity.class);
            graphIntent.putExtra("file_name", getString(com.spectrosmart.NanoScan.R.string.newScan));
            startActivity(graphIntent);
        }
...
//        Field[] files = com.spectrosmart.NanoScan.R.raw.class.getFields();
//
...
//        }
    ...
    public void renameFile(final String csvFileUrl, int position) {
...
//        input.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
        ...
        final String fileName = csvFileUrl.substring(0, csvFileUrl.length() - 4);
    ...
    private SwipeMenuCreator createMenu() {
        return new SwipeMenuCreator() {
            ...
            public void create(SwipeMenu menu) {
                ...
                // set item background
                settingsItem.setBackground(com.spectrosmart.NanoScan.R.color.kst_red);
                // set item width
                settingsItem.setWidth(dp2px(90));
                // set a icon
                //settingsItem.setIcon(android.R.drawable.ic_menu_delete);
                settingsItem.setTitleColor(ContextCompat.getColor(mContext, com.spectrosmart.NanoScan.R.color.white));
                settingsItem.setTitleSize(18);
                settingsItem.setTitle(getResources().getString(com.spectrosmart.NanoScan.R.string.delete));


                SwipeMenuItem editItem = new SwipeMenuItem(
                        getApplicationContext());
                // set item background
                editItem.setBackground(com.spectrosmart.NanoScan.R.color.blue);
                // set item width
                editItem.setWidth(dp2px(90));
                // set a icon
                //settingsItem.setIcon(android.R.drawable.ic_menu_delete);
                editItem.setTitleColor(ContextCompat.getColor(mContext, com.spectrosmart.NanoScan.R.color.white));
